                        ...
                        <div class="card" style="width: 28rem;">
                            <div class="card-body p-2 m-2 space-y-1">
                              ...
                              {{$call_index+1}}</span>
                                ...
                                <a href="#" class="card-link btn-primary btn block" id="beginButton"   wire:click="beginGame" >Begin Now</a>
                                <a href="#" class="card-link btn-primary btn col-md-3 " id="startButton"  >Auto Call</a>


                                <a href="#" class="card-link btn-info btn col-md-4  " id="stopButton" >Pause Call</a>

                                <a href="#" class="card-link btn-secondary btn col-md-3 " id="nextButton"  wire:click="nextCall">Next Call</a>
